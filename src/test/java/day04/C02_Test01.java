...
public class C02_Test01 {
    public static void main(String[] args) {
        ...
        String arananaKelime = "Save";
        String actuelTitle = driver.getTitle();
        if (actuelTitle.contains(arananaKelime)) {
            System.out.println("title " + arananaKelime + " kelimesini iceriyor, test PASS..");
        } else {
            System.out.println("title " + arananaKelime + " kelimesini icermiyor, test FAILED..");
        }
        ...
        if (expectedTitle.equals(actuelTitle)) {
            ...
            System.out.println("title beklenen ile ayni degil, test FAILED..");
        ...
        WebElement aramaSonucu = driver.findElement(By.xpath("//div[@class='inline-flex mv3-xl mt3 ml3 ml4-xl mr1 db']"));
